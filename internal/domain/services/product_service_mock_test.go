...
//go:generate minimock -i awesomeProject4/internal/domain/services.ProductService -o product_service_mock_test.go -n ProductServiceMock -p services
...
type ProductServiceMock struct {
	...
	funcGetProduct          func(ctx context.Context, sku int64) (pp1 *models.Product, err error)
...
func (mmGetProduct *mProductServiceMockGetProduct) Set(f func(ctx context.Context, sku int64) (pp1 *models.Product, err error)) *ProductServiceMock {
	if mmGetProduct.defaultExpectation != nil {
...
func (mmGetProduct *ProductServiceMock) GetProduct(ctx context.Context, sku int64) (pp1 *models.Product, err error) {
